          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-9  p-0 m-0 g-0">
              <div className="formset">
                  ...
                  <Form noValidate validated={validated} onSubmit={handleSubmit} className='m-0'>
                    <Form.Group controlId="validationCustomUsername">
                      <InputGroup hasValidation>
                        <InputGroup.Text id="inputGroupPrepend" className="inputtext"><BsFillPersonFill /></InputGroup.Text>
                        <Form.Control
                          type="text"
                ...
                <h6>All ready have an account?<span className='text-decoration-underline ms-1 loginlastcolor fs-5'><Link href="/login">Log in</Link></span></h6>
              </div>
            </div>
          </div>
        </h2>
